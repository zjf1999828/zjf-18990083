...
import com.example.homework4.util.ViewUtil;
...
public class MainActivity extends AppCompatActivity implements View.OnClickListener, View.OnFocusChangeListener {
    ...
    private Switch sw_ios; // 声明一个复选框对象
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //跳转登陆成功界面
        final Button LoginActivity = (Button) findViewById(R.id.btn_login);
        LoginActivity.setOnClickListener(new View.OnClickListener() {
            public void onClick(View view) {
                //提示框确定是否跳转
                new AlertDialog.Builder(MainActivity.this).setTitle("跳转").setMessage("是否准备跳转?")
    ...
    // 初始化用户类型的下拉框
    private String[] typeArray = {"个人用户", "公司用户", "18990083-赵金峰"};
